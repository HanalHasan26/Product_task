...
export const routes = [
  ...
  { path: `${process.env.PUBLIC_URL}/form-widget/datetimepicker/:layout`, Component: <DateTimeContain /> },
  { path: `${process.env.PUBLIC_URL}/form-widget/rangepicker/:layout`, Component: <FormDateRangepickerContain /> },
  { path: `${process.env.PUBLIC_URL}/form-widget/select2/:layout`, Component: <FormSelectContain /> },
  { path: `${process.env.PUBLIC_URL}/form-widget/switch/:layout`, Component: <FormSwitchContain /> },
  { path: `${process.env.PUBLIC_URL}/form-widget/touchspin/:layout`, Component: <FormTouchspinContain /> },
  { path: `${process.env.PUBLIC_URL}/form-widget/clipboard/:layout`, Component: <FormClipboardContain /> },
  ...
  { path: `${process.env.PUBLIC_URL}/table/reactstraptable/sizing/:layout`, Component: <SizingTable /> },
  { path: `${process.env.PUBLIC_URL}/table/reactstraptable/border/:layout`, Component: <BorderTable /> },
  { path: `${process.env.PUBLIC_URL}/table/reactstraptable/styling/:layout`, Component: <StylingTable /> },
  ...
  { path: `${process.env.PUBLIC_URL}/app/contact-app/firebase/:layout`, Component: <ContactFirebase /> },
  ...
  { path: `${process.env.PUBLIC_URL}/app/todo-firebase/:layout`, Component: <TodoFirebaseContain /> },
  ...
  { path: `${process.env.PUBLIC_URL}/app/calendar/basic-calendar/:layout`, Component: <CalenderContain /> },
  ...
  { path: `${process.env.PUBLIC_URL}/pages/search-result/:layout`, Component: <SearchResultContain /> },
