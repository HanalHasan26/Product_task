...
const MixLayoutComponent = () => {
  ...
  const [active, setActive] = useState('light-only');
  ...
  return (
    <Fragment>
      ...
      <UL attrUL={{ className: 'layout-grid customizer-mix flex-row' }}>
        <LI
          attrLI={{
            className: `color-layout ${active === 'light-only' ? 'active' : ''}`,
            dataattr: 'light-only',
        ...
        <LI
          attrLI={{
            className: `color-layout ${active === 'dark-sidebar' ? 'active' : ''}`,
        ...
        <LI
          attrLI={{
            className: `color-layout ${active === 'dark-only' ? 'active' : ''}`,
            dataattr: 'dark-only',
