        ...
        <CardBody className="avatar-showcase">
          <div className="customers d-inline-block avatar-group">
            <UL attrUL={{ as: 'ul', className: 'simple-list' }}>
              <LI attrLI={{ className: 'd-inline-block border-0' }} ><Image attrImage={{ body: true, className: 'img-70 rounded-circle', src: `${require('../../../assets/images/user/3.jpg')}`, alt: '' }} /></LI>
              <LI attrLI={{ className: 'd-inline-block border-0' }}><Image attrImage={{ body: true, className: 'img-70 rounded-circle', src: `${require('../../../assets/images/user/5.jpg')}`, alt: '' }} /></LI>
              <LI attrLI={{ className: 'd-inline-block border-0' }}><Image attrImage={{ body: true, className: 'img-70 rounded-circle', src: `${require('../../../assets/images/user/1.jpg')}`, alt: '' }} /></LI>
            </UL>
          </div>
          <div className="customers d-inline-block avatar-group">
            <UL attrUL={{ as: 'ul', className: 'simple-list' }}>
