                                    ...
                                    <div className="faq-image product-img">
                                        ...
                                        <div className="product-hover">
                                            <UL attrUL={{ className: 'simple-list flex-row' }}>
                                                <LI attrLI={{ className: 'border-0' }}><Link onClick={clickApply} /></LI>
                                                <LI attrLI={{ className: 'border-0' }}><Download /></LI>
                                            </UL>
                                        </div>
                                    </div>
                                    <CardBody>
                                        <H6><NavLink to={`${process.env.PUBLIC_URL}/app/knowledgebase-detail/${layoutURL}`}>
                                            {item.title}
                                        </NavLink></H6>
