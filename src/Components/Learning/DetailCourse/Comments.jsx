                        ...
                        <Media body>
                            <Row>
                                ...
                                <Col md="8" className='xl-100'>
                                    <UL attrUL={{ className: 'simple-list comment-social float-start float-md-end learning-comment flex-row' }} >
                    ...
                    <Media>
                        ...
                        <Media body>
                            <Row>
                                ...
                                <Col md="8" className='xl-100'>
                                    <UL attrUL={{ className: 'comment-social float-start float-md-end learning-comment flex-row' }} >
                                        <LI attrLI={{ className: 'digits' }} ><i className="icofont icofont-thumbs-up"></i>{'02 Hits'}</LI>
                                        <LI attrLI={{ className: 'digits' }}><i className="icofont icofont-ui-chat"></i>{'598 Comments'}</LI>
                                    </UL>
                                </Col>
