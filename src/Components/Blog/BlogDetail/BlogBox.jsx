                    ...
                    <div className="blog-box blog-shadow">
                        ...
                        <div className="blog-details">
                            ...
                            <UL attrUL={{ className: 'blog-social flex-row' }} >
                                <LI attrLI={{ className: 'blog-li ' }}><i className="icofont icofont-user"></i>{MarkJecno}</LI>
                                <LI attrLI={{ className: 'blog-li digits ' }}><i className="icofont icofont-thumbs-up"></i>{'02 Hits'}</LI>
                                <LI attrLI={{ className: 'blog-li digits ' }}><i className="icofont icofont-ui-chat"></i>{'598 Comments'}</LI>
                            </UL>
                        </div>
                    </div>
                </Card>
