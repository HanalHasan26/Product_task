        ...
        <Fragment>
            <Row id="bookmarkData">
                {bookmark.length > 0 ? (
                    bookmark.map((data) => {
                        return (
                            <Col xl="3" className='xl-50 box-col-4' lg="6" sm="6" md="4" key={data.id}>
                                            ...
                                            <div className="title-bookmark">
                                                ...
                                                <div className="hover-block">
                                                    <UL attrUL={{ className: 'simple-list flex-row' }}>
                                                        <LI attrLI={{ className: 'border-0' }}><a href="#javascript" onClick={() => OnHandleClick(data)}><i className="fa fa-edit"></i></a></LI>
                                                        ...
                                                        <LI attrLI={{ className: 'border-0' }}> <a href="#javascript" onClick={() =>
                                                            Removefrombookmark(data.id, data.fillstar)} >
                                                            <i className="fa fa-trash-o"></i> </a>
                                                        </LI>
                                                        <LI attrLI={{ className: "pull-right text-end border-0" }} > <a href="#javascript"> <i className="fa fa-tag"></i> </a></LI>
                                                    </UL>
                                                </div>
