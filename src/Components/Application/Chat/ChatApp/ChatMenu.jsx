            ...
            <TabContent activeTab={activeTab}>
                ...
                <TabPane tabId="2">
                    ...
                    <div className="status">
                        <P attrPara={{ className: 'font-dark' }} >{Active}</P> <hr /><P>{ChataApp_p1}&nbsp;&nbsp;
                    ...
                    <div className="user-profile">
                        ...
                        <div className="user-content text-center"><H5 attrH5={{ className: 'text-center text-uppercase' }} >{MarkJecno}</H5>
                            <div className="social-media">
                                <UL attrUL={{ className: 'list-inline' }}>
                                    <LI attrLI={{ className: 'list-inline-item' }}><a href="https://www.facebook.com/"><i className="fa fa-facebook"></i></a></LI>
                                    <LI attrLI={{ className: 'list-inline-item' }}><a href="https://accounts.google.com/"><i className="fa fa-google-plus"></i></a></LI>
                                    <LI attrLI={{ className: 'list-inline-item' }}><a href="https://twitter.com/"><i className="fa fa-twitter"></i></a></LI>
                                    <LI attrLI={{ className: 'list-inline-item' }}><a href="https://www.instagram.com/"><i className="fa fa-instagram"></i></a></LI>
                                    <LI attrLI={{ className: 'list-inline-item' }}><a href="https://dashboard.rss.com/auth/sign-in/"><i className="fa fa-rss"></i></a></LI>
                                </UL>
                            </div>
                            <hr />
                            <div className="follow text-center">
                                <Row>
                                    <Col className="border-end"><span>{Following}</span><div className="follow-num">{'236k'}</div> </Col>
