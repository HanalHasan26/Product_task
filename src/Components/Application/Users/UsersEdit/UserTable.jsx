                ...
                <div className="table-responsive edit-table">
                    <table className="table card-table table-vcenter text-nowrap">
                        ...
                        <tbody>
                            ...
                            {data.map((items, i) =>
                                <tr key={i}>
                                    <td><Link to={`${process.env.PUBLIC_URL}/app/project/project-list/${layoutURL}`}>{items.projectName}</Link></td>
                                    <td>{items.date}</td>
                                    <td><span className="status-icon bg-success"></span>{items.status}</td>
                                    <td>{items.price}</td>
                                    <td className="text-end">
                                        <Btn attrBtn={{ color: "primary", size: "sm" }} ><i className="fa fa-pencil"></i> {Edit}</Btn>
                                        <Btn attrBtn={{ color: "transparent", size: "sm" }} ><i className="fa fa-link"></i> {Update}</Btn>
                                        <Btn attrBtn={{ color: "danger", size: "sm" }} ><i className="fa fa-trash"></i> {Delete}</Btn>
                                    </td>
                                </tr>
                            )}
                        </tbody>
