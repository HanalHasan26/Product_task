...
import { Card, Row, Media, Label, Input, Col, Form, FormGroup } from 'reactstrap';
                                    ...
                                    <div className="email-content">
                                            ...
                                            <Row>
                                                ...
                                                <Col md="6" sm="12">
                                                    <div className="float-end d-flex">
                                                        <P attrPara={{ className: 'user-emailid' }}>{"Lormlpsa"}<span className="digits">{"23"}</span>{"@company.com"}</P>
                                        ...
                                        <div className="email-wrapper">
                                            ...
                                            <div className="d-inline-block">
                                                <H6 className="text-muted"><i className="icofont icofont-clip"></i> {ATTACHMENTS}</H6>
                                                <a className="text-muted text-end right-download" href="#javascript"><i className="fa fa-long-arrow-down me-2"></i>{DownloadAll}</a>
                                                <div className="clearfix"></div>
                                            </div>
                                            <div className="attachment">
                                                <UL attrUL={{ className: "list-inline d-flex flex-row" }} >
                                                    <LI attrLI={{ className: "list-inline-item border-0" }} ><Image attrImage={{ className: "img-fluid", src: `${email1}`, alt: "" }} /></LI>
                                                    <LI attrLI={{ className: "list-inline-item border-0" }} ><Image attrImage={{ className: "img-fluid", src: `${email2}`, alt: "" }} /></LI>
                                                    <LI attrLI={{ className: "list-inline-item border-0" }} ><Image attrImage={{ className: "img-fluid", src: `${email3}`, alt: "" }} /></LI>
                                                </UL>
                                            </div>
                                            <hr />
                                            <div className="action-wrapper">
                                                <UL attrUL={{ className: "actions flex-row" }} >
                                                    <LI arreLI={{ className: 'border-0' }}><a className="text-muted" href="#javascript"><i className="fa fa-reply me-2"></i>{Reply}</a></LI>
                                                    <LI arreLI={{ className: 'border-0' }}><a className="text-muted" href="#javascript"><i className="fa fa-reply-all me-2"></i>{ReplyAll}</a></LI>
                                                    <LI arreLI={{ className: 'border-0' }}><a className="text-muted" href="#javascript"><i className="fa fa-share me-2"></i></a>{Forward}</LI>
                                                </UL>
                                            </div>
                                        </div>
                                    </div>
