                            ...
                            <div className="inbox custom-scrollbar">
                                {
                                    selectedFav ?
                                        allEmails.filter((email) => email.favourite === true).length > 0 ?
                                            allEmails.filter((email) => email.favourite === true).map((list, index) => {
                                                return (
                                                    <AllEmailsClass list={list} selectMailCallback={selectMailCallback} selectedmailCallback={selectedmailCallback} key={index} checked={checked} />
                                                )
                                            })
                                            :
                                            <EmptyClass />
