                                    ...
                                    <tbody>
                                        {
                                            cart.map((item, i) => {
                                                return (
                                                    <tr key={i}>
                                                        <td>
                                                            <Image attrImage={{ className: 'img-fluid img-60', src: `${dynamicImage(item.img)}`, alt: '#' }} />
                                                        </td>
                                        ...
                                        <tr>
                                            <td className="text-end" colSpan="5"><Link to={`${process.env.PUBLIC_URL}/app/ecommerce/product/${layoutURL}`} className="btn btn-secondary cart-btn-transform">continue shopping</Link></td>
                                            <td><Link className="btn btn-success cart-btn-transform" to={`${process.env.PUBLIC_URL}/app/ecommerce/checkout/${layoutURL}`}>check out</Link></td>
                                        </tr>
                                    </tbody>
                                </Table>
                            </div>
