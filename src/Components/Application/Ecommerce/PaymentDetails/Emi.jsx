...
const EMIs = () => {
    return (
        <Fragment>
            <Col lg="6" xl="4" className='box-col-6 xl-50'>
                <Card>
                        ...
                        <Row className="theme-form">
                            ...
                            <FormGroup className="mb-3 col-12">
                                <UL attrUL={{ className: 'simple-list payment-opt d-flex flex-row' }}>
                                    <LI attrLI={{ className: "border-0" }}><Image attrImage={{ src: `${mastercard}`, alt: '' }} /> </LI>
                                    <LI attrLI={{ className: "border-0" }}> <Image attrImage={{ src: `${visa}`, alt: '' }} /></LI>
                                    <LI attrLI={{ className: "border-0" }}><Image attrImage={{ src: `${paypal}`, alt: '' }} /> </LI>
                                </UL>
                            </FormGroup>
                            <div className="col-12">
                                <Btn attrBtn={{ color: 'primary', className: 'btn btn-primary d-block w-100' }}>
                                    {Submit}
                                </Btn>
                            </div>
                        </Row>
