                            ...
                            <div className="product-box row">
                                ...
                                <Col lg="6" className="product-details text-start">
                                    ...
                                    <div className="product-size">
                                        <UL attrUL={{ className: 'simple-list flex-row' }}>{ProductSizeArray.map((items, i) => <LI attrLI={{ className: 'border-0' }} key={i}>
                                    ...
                                    <div className="product-qnty">
                                        ...
                                        <div className="addcart-btn">
                                            <Link to={`${process.env.PUBLIC_URL}/app/ecommerce/cart/${layoutURL}`} className="btn btn-primary me-3 mt-2" onClick={() => AddToCarts(singleProduct, quantity)}>{AddToCart}</Link>
                                            <Link
                                                to={`${process.env.PUBLIC_URL}/app/ecommerce/product-page/${layoutURL}/${singleProduct.id}`}
                                                className="btn btn-primary mt-2">{ViewDetails}
                                            </Link>
                                        </div>
                                    </div>
                                </Col>
