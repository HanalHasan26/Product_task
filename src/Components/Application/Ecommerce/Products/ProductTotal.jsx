                ...
                <Col md="6" className="products-total" >
                    ...
                    <div className="grid-options d-inline-block">
                        <UL attrUL={{ className: 'list-group', as: 'ul' }} >
                            ...
                            <LI attrLI={{ className: 'border-0' }}><a className="product-3-layout-view" onClick={() => LayoutView(4)} href="#javascript" >
                            ...
                            <LI attrLI={{ className: 'border-0' }}><a className="product-4-layout-view" onClick={() => LayoutView(3)} href="#javascript" >
