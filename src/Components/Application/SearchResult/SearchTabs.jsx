  ...
  return (
    <Fragment>
      <Nav tabs className="search-list" id="top-tab" role="tablist">
        ...
        <NavItem><NavLink className={activeTab === '4' ? 'active' : ''}><i className="icon-volume" ></i>Audio</NavLink>
          <div className="material-border"></div>
        </NavItem>
        <NavItem className="bg-light-success"><NavLink className={activeTab === '5' ? 'active' : 'txt-success'}><i className="icon-map-alt" ></i>Maps</NavLink>
          <div className="material-border"></div>
        </NavItem>
        <NavItem className="bg-light-secondary"><NavLink className={activeTab === '6' ? 'active' : 'txt-secondary'} ><i className="icon-settings"></i>Settings</NavLink>
          <div className="material-border"></div>
        </NavItem>
      </Nav>
    </Fragment>
