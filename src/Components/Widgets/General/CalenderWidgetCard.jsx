                ...
                <Card className="height-equal">
                    <div className="calender-widget">
                        ...
                        <CardBody className="cal-desc text-center">
                            ...
                            <P attrPara={{ className: 'text-muted mt-3 mb-0' }}>Denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth,Letraset sheets containing Lorem Ipsum passages.</P>
                        </CardBody>
                    </div>
                </Card>
            </Col>
